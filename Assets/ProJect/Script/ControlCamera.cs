...
public class ControlCamera : MonoBehaviour
{
    ...
    private FactorMenuContrl faceMenu;
    private void Awake()
    {
        Camera = Camera.main;
        cameraStartPosition = Camera.transform.position;

        faceMenu = GameObject.Find("FactorMenuContrl").GetComponent<FactorMenuContrl>();
    }

    private void Update()
    {

        if (faceMenu.isChongYa == false && faceMenu.isHanJie == false && faceMenu.ZongZhuang == false && faceMenu.TuZhuang == false)
        {
            //Update Plane
